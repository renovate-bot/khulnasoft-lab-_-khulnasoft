...
When contributing to this repository, please first discuss the change you wish to make via [GitHub Discussions](https://github.com/khulnasoft-lab/khulnasoft/discussions/new) with the owners of this repository before submitting a Pull Request.
...
```
git clone https://github.com/khulnasoft-lab/khulnasoft
cd vercel
corepack enable
pnpm install
pnpm build
