...
const PLUGIN_PATHS: Record<PluginName, string> = {
  '@khulnasoft/gatsby-plugin-khulnasoft-analytics': path.dirname(
    require_.resolve(
      `@khulnasoft/gatsby-plugin-khulnasoft-analytics/package.json`
    )
  ),
  '@khulnasoft/gatsby-plugin-khulnasoft-builder': path.dirname(
    require_.resolve(
      `@khulnasoft/gatsby-plugin-khulnasoft-builder/package.json`
    )
  ),
};
...
const GENERATED_FILE_COMMENT = `// This file was generated by @khulnasoft/static-build`;
